...
export const chapter10Data: ChapterData = {
  chapterId: 10,
  chapterTitle: '旋转体体积与平面面积',
  book: '张宇30讲',
  mainSource: '张宇30讲第10讲 · 一元函数积分学的应用（一）——几何应用',
  description: '平面面积、旋转体体积、函数平均值——圆盘法、柱壳法、非坐标轴旋转、反常积分、综合应用',
  stages: [
    { id: 0, name: '引气入体' },
    { id: 1, name: '炼气' },
    { id: 2, name: '筑基' },
  ...
  knowledgePoints: [
    '平面图形面积', '圆盘法(垫片法)', '柱壳法', '绕x轴', '绕y轴',
    '非坐标轴旋转', '参数方程旋转体', '反常积分型体积',
    '两曲线区域', '分段函数区域', '定义域判断',
    '函数的平均值', '方法选择', '微元法', '综合应用',
  ],
  modules: [
    { id: 'area',        name: '平面面积',       order: 0 },
    { id: 'disk',        name: '圆盘法·绕x轴',  order: 1 },
    { id: 'shell',       name: '柱壳法·绕y轴',  order: 2 },
    { id: 'two-curves',  name: '两曲线区域',     order: 3 },
    { id: 'non-axis',    name: '非坐标轴旋转',   order: 4 },
    { id: 'comprehensive', name: '综合应用',     order: 5 },
  ],
  tasks: [
    ...
    },
    {
      ...
      title: '切线+面积+绕x轴体积',
      source: '2012年数二真题 · 数三可做 · 武忠祥基础篇 例4 | 已核验 | 数三可做',
      sourceType: 'skill',
      time: '15分钟', difficulty: 3,
